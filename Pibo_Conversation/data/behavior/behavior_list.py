...
# my module
sys.path.append('/home/pi/Pibo_Package_04/Pibo_Conversation/data')
...
def do_question_L():
    ...
    t.start()
    while True: 
        audio.audio_play(filename="/home/pi/Pibo_Package_04/Pibo_Conversation/data/behavior/audio/sound_question1.wav", out='local', volume=-1500, background=True)
...
def do_photo():
    ...
    while True:
        ...
        break
    audio.audio_play(filename="/home/pi/Pibo_Package_04/Pibo_Conversation/data/behavior/audio/sound_camera.mp3", out='local', volume=-1500, background=True)
    while True:
...
def do_stamp():
    ...
    while True:
        ...
        break
    audio.audio_play(filename="/home/pi/Pibo_Package_04/Pibo_Conversation/data/behavior/audio/sound_stamp2.wav", out='local', volume=-1500, background=True)
    while True:
...
def do_wakeup():
    ...
    t.start()
    while True:
        audio.audio_play(filename="/home/pi/Pibo_Package_04/Pibo_Conversation/data/behavior/audio/sound_cheerful2.wav", out='local', volume=-1500, background=True)
...
def do_agree():
    ...
    t.start()
    while True:
        audio.audio_play(filename="/home/pi/Pibo_Package_04/Pibo_Conversation/data/behavior/audio/sound_correct3.wav", out='local', volume=-1500, background=False)
...
def do_joy_A():
    ...
    t.start()
    while True:
        # audio.audio_play(filename="/home/pi/Pibo_Package_04/Pibo_Conversation/data/behavior/audio/sound_cheerfulness2.wav", out='local', volume=-1500, background=True)
...
def do_sad():
    ...
    t.start()
    while True:
        audio.audio_play(filename="/home/pi/Pibo_Package_04/Pibo_Conversation/data/behavior/audio/sound_sad.wav", out='local', volume=-1500, background=True)
