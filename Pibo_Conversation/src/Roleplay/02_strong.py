...
class Roleplay():    
    ...
    def Strong(self):
        ...
        audio.audio_play("/home/pi/Pibo_Package_04/Pibo_Conversation/src/Roleplay/Sound/15_tiger.wav")          
        ...
        # 5. 활동 완료 기록
        gss.write_sheet(name=self.user_name, today=f'(1)_{self.today}', activities=filename)
